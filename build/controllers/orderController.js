...
class orderController {
  ...
  async triggerEmail(req, res) {
    try {
      const emailTemplate = fs.readFileSync(path.join('D:', 'monfee', 'monfee-be-nodejs', 'views', 'email-template.html'), 'utf8');
      ...
      await emailController.sendEmail(email, 'Order Confirmation', 'Please see the order details in the email body.', html);
      return res.status(200).json({
